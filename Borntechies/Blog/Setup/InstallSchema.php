    ...
    public function install(SchemaSetupInterface $setup, ModuleContextInterface $context)
    {
        ...
        if (!$installer->tableExists('borntechies_blog_post')) {
            $table = $installer->getConnection()
                ->newTable($installer->getTable('borntechies_blog_post'))
        ...
        if (!$installer->tableExists('borntechies_blog_tag')) {
            $table = $installer->getConnection()
                ->newTable($installer->getTable('borntechies_blog_tag'))
        ...
        if (!$installer->tableExists('borntechies_blog_topic')) {
            $table = $installer->getConnection()
                ->newTable($installer->getTable('borntechies_blog_topic'))
        ...
        if (!$installer->tableExists('borntechies_blog_category')) {
            $table = $installer->getConnection()
                ->newTable($installer->getTable('borntechies_blog_category'))
        ...
        if (!$installer->tableExists('borntechies_blog_post_tag')) {
            $table = $installer->getConnection()
                ->newTable($installer->getTable('borntechies_blog_post_tag'))
                ->addColumn('tag_id', Table::TYPE_INTEGER, null, [
                    'unsigned' => true,
                    'primary'  => true,
                    'nullable' => false
                ...
                ->addIndex($installer->getIdxName('borntechies_blog_post_tag', ['post_id']), ['post_id'])
                ->addIndex($installer->getIdxName('borntechies_blog_post_tag', ['tag_id']), ['tag_id'])
                ->addForeignKey(
                    $installer->getFkName('borntechies_blog_post_tag', 'post_id', 'borntechies_blog_post', 'post_id'),
                    'post_id',
                ...
                ->addForeignKey(
                    $installer->getFkName('borntechies_blog_post_tag', 'tag_id', 'borntechies_blog_tag', 'tag_id'),
                    'tag_id',
        ...
        if (!$installer->tableExists('borntechies_blog_post_topic')) {
            $table = $installer->getConnection()
                ->newTable($installer->getTable('borntechies_blog_post_topic'))
                ->addColumn('topic_id', Table::TYPE_INTEGER, null, [
                    'unsigned' => true,
                    'primary'  => true,
                    'nullable' => false
                ...
                ->addIndex($installer->getIdxName('borntechies_blog_post_topic', ['post_id']), ['post_id'])
                ->addIndex($installer->getIdxName('borntechies_blog_post_topic', ['topic_id']), ['topic_id'])
                ->addForeignKey(
                    $installer->getFkName('borntechies_blog_post_topic', 'post_id', 'borntechies_blog_post', 'post_id'),
                    'post_id',
                    $installer->getTable('borntechies_blog_post'),
                    'post_id',
                    Table::ACTION_CASCADE
                ...
                ->addForeignKey(
                    $installer->getFkName(
                        'borntechies_blog_post_topic',
                        'topic_id',
                        'borntechies_blog_topic',
                        'topic_id'
                    ),
                    'topic_id',
        ...
        if (!$installer->tableExists('borntechies_blog_post_category')) {
            $table = $installer->getConnection()
                ->newTable($installer->getTable('borntechies_blog_post_category'))
                ->addColumn('category_id', Table::TYPE_INTEGER, null, [
                    'unsigned' => true,
                    'primary'  => true,
                    'nullable' => false
                ...
                ->addIndex($installer->getIdxName('borntechies_blog_post_category', ['category_id']), ['category_id'])
                ->addIndex($installer->getIdxName('borntechies_blog_post_category', ['post_id']), ['post_id'])
                ->addForeignKey(
                    $installer->getFkName(
                        'borntechies_blog_post_category',
                        'category_id',
                        'borntechies_blog_category',
                        'category_id'
                    ),
                    'category_id',
