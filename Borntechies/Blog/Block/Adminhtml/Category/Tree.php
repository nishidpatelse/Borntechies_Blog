...
use Borntechies\Blog\Model\ResourceModel\Category\Tree as BlogTreeResource;
...
class Tree extends \Magento\Catalog\Block\Adminhtml\Category\Tree
{
    ...
    {
        return $this->getUrl('borntechies_blog/category/jsonTree');
    }
    ...
    {
        return $this->getUrl('borntechies_blog/category/move');
    }
