...
use Borntechies\Blog\Model\CategoryFactory as BlogCategoryFactory;
use Borntechies\Blog\Model\ResourceModel\Category\Tree as BlogResourceTree;
...
class Form extends AbstractCategory
{
    ...
    protected function _prepareLayout()
    {
        ...
        $this->addButton('save', [
            ...
            'data_attribute' => [
                'mage-init' => [
                    'Borntechies_Blog/category/edit' => [
                        'url'  => $this->getSaveUrl(),
                        'ajax' => true
                    ]
                ]
        ...
        // Reset button
        $resetPath = $categoryId ? 'borntechies_blog/*/edit' : 'borntechies_blog/*/add';
    ...
    {
        /** @var \Borntechies\Blog\Model\Category $category */
        ...
        return $this->getUrl('borntechies_blog/*/save', $params);
    }
    ...
    {
        return $this->getUrl('borntechies_blog/category/edit', ['_query' => false, 'id' => null, 'parent' => null]);
    }
    ...
    public function getDeleteUrl(array $args = [])
    {
        ...
        return $this->getUrl('borntechies_blog/*/delete', $params);
    }
    ...
    public function getRefreshPathUrl(array $args = [])
    {
        ...
        return $this->getUrl('borntechies_blog/*/refreshPath', $params);
    }
