...
namespace Borntechies\Blog\Block\Adminhtml\Category\Edit\Tab;
...
/**
 * Class Post
 * @package Borntechies\Blog\Block\Adminhtml\Category\Edit\Tab
 */
class Post extends Extended implements TabInterface
{
    ...
    protected function _prepareCollection()
    {
        ...
        $collection->getSelect()->joinLeft(
            ['related' => $collection->getTable('borntechies_blog_post_category')],
    ...
    /**
     * @return \Borntechies\Blog\Model\Category
     */
    ...
    {
        return $this->getUrl('borntechies_blog/category/posts', ['_current' => true]);
    }
