...
namespace Borntechies\Blog\Block\Adminhtml\Topic\Edit\Tab;
...
/**
 * Class Post
 * @package Borntechies\Blog\Block\Adminhtml\Topic\Edit\Tab
 */
class Post extends Extended implements TabInterface
{
    ...
    protected function _prepareCollection()
    {
        ...
        $collection->getSelect()->joinLeft(
            ['related' => $collection->getTable('borntechies_blog_post_topic')],
    ...
    /**
     * @param \Borntechies\Blog\Model\Post|Object $item
     *
     * @return string
     */
    ...
    /**
     * @return \Borntechies\Blog\Model\Topic
     */
    public function getTopic()
    {
        return $this->coreRegistry->registry('borntechies_blog_topic');
    }
    ...
    {
        return $this->getUrl('borntechies_blog/topic/posts', ['_current' => true]);
    }
