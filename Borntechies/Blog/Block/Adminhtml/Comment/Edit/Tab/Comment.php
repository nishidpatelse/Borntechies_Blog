...
namespace Borntechies\Blog\Block\Adminhtml\Comment\Edit\Tab;
...
/**
 * Class Comment
 * @package Borntechies\Blog\Block\Adminhtml\Comment\Edit\Tab
 */
class Comment extends Generic implements TabInterface
{
    ...
    {
        $comment = $this->_coreRegistry->registry('borntechies_blog_comment');
        ...
        $postText = '<a href="' . $this->getUrl('borntechies_blog/post/edit', ['id' => $comment->getPostId()])
