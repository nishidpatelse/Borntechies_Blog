...
class Post extends Extended implements TabInterface
{
    ...
    {
        return $this->getUrl('borntechies_blog/post/edit', ['id' => $item->getId()]);
    }
    ...
    /**
     * @return \Borntechies\Blog\Model\Author
     */
    ...
    {
        return $this->getUrl('borntechies_blog/author/posts', ['_current' => true]);
    }
