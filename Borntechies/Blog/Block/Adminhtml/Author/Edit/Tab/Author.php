...
namespace Borntechies\Blog\Block\Adminhtml\Author\Edit\Tab;
...
use Borntechies\Blog\Block\Adminhtml\Renderer\Image;
use Borntechies\Blog\Helper\Data;
use Borntechies\Blog\Helper\Image as ImageHelper;
use Borntechies\Blog\Model\Config\Source\AuthorStatus;

/**
 * Class Author
 * @package Borntechies\Blog\Block\Adminhtml\Author\Edit\Tab
 */
class Author extends Generic implements TabInterface
{
    ...
    protected function _prepareForm()
    {
        ...
        $author = $this->_coreRegistry->registry('borntechies_blog_author');
        ...
        if ($this->checkCustomerId($author->getCustomerId())) {
            ...
            $fieldset->addField('customer', 'text', [
                ...
                <script type="text/x-magento-init">
                    {
                        "#author_customer": {
                            "Borntechies_Blog/js/view/author":{
                                "url": "' . $this->getAjaxUrl() . '"
                            }
                        }
                    }
    ...
    {
        return $this->getUrl('borntechies_blog/author/customergrid');
    }
}
