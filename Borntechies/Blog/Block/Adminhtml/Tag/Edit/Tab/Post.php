...
namespace Borntechies\Blog\Block\Adminhtml\Tag\Edit\Tab;
...
/**
 * Class Post
 * @package Borntechies\Blog\Block\Adminhtml\Tag\Edit\Tab
 */
class Post extends Extended implements TabInterface
{
    ...
    protected function _prepareCollection()
    {
        ...
        $collection->getSelect()->joinLeft(
            ['related' => $collection->getTable('borntechies_blog_post_tag')],
    ...
    /**
     * @return \Borntechies\Blog\Model\Tag
     */
    public function getTag()
    {
        return $this->coreRegistry->registry('borntechies_blog_tag');
    }
    ...
    {
        return $this->getUrl('borntechies_blog/tag/posts', ['_current' => true]);
    }
