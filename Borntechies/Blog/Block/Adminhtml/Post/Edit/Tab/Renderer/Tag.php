...
use Borntechies\Blog\Model\ResourceModel\Tag\Collection;
use Borntechies\Blog\Model\ResourceModel\Tag\CollectionFactory as BlogTagCollectionFactory;
...
class Tag extends Multiselect
{
    ...
    {
        $isNotAllowed = !$this->authorization->isAllowed('Borntechies_Blog::tag');
    ...
    public function getAfterElementHtml()
    {
        $html = '<script type="text/x-magento-init">
            ...
            $this->_urlBuilder->getUrl(
                ...
                [
                    'handle' => 'borntechies_blog_tag_create',
                    'buttons' => 1
                ]
            ) . '",
                                        "autoRender": false,
