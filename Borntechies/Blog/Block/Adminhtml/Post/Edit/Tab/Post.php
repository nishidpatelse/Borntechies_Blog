...
use Borntechies\Blog\Block\Adminhtml\Post\Edit\Tab\Renderer\Category;
use Borntechies\Blog\Block\Adminhtml\Post\Edit\Tab\Renderer\Tag;
use Borntechies\Blog\Block\Adminhtml\Post\Edit\Tab\Renderer\Topic;
use Borntechies\Blog\Helper\Image;
use Borntechies\Blog\Model\Config\Source\Author;
...
class Post extends Generic implements TabInterface
{
    ...
    protected function _prepareForm()
    {
        ...
        $post = $this->_coreRegistry->registry('borntechies_blog_post');
        ...
        $fieldset->addField('image', \Borntechies\Blog\Block\Adminhtml\Renderer\Image::class, [
            'name' => 'image',
            'label' => __('Image'),
            'title' => __('Image'),
