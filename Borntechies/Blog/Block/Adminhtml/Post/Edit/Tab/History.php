...
namespace Borntechies\Blog\Block\Adminhtml\Post\Edit\Tab;
...
use Borntechies\Blog\Block\Adminhtml\Post\Edit\Tab\Renderer\History\Action;
use Borntechies\Blog\Block\Adminhtml\Post\Edit\Tab\Renderer\History\Author;
use Borntechies\Blog\Block\Adminhtml\Post\Edit\Tab\Renderer\History\Categories;
use Borntechies\Blog\Block\Adminhtml\Post\Edit\Tab\Renderer\History\Store;
use Borntechies\Blog\Block\Adminhtml\Post\Edit\Tab\Renderer\History\Tags;
use Borntechies\Blog\Block\Adminhtml\Post\Edit\Tab\Renderer\History\Topics;
use Borntechies\Blog\Model\ResourceModel\PostHistory\Collection;
use Borntechies\Blog\Model\Tag;

/**
 * Class Product
 * @package Borntechies\Blog\Block\Adminhtml\Post\Edit\Tab
 */
class History extends Extended implements TabInterface
{
    ...
    /**
     * @return \Borntechies\Blog\Model\Post
     */
    public function getPost()
    {
        return $this->coreRegistry->registry('borntechies_blog_post');
    }
    ...
    {
        return $this->getUrl('borntechies_blog/post/history', ['_current' => true]);
    }
