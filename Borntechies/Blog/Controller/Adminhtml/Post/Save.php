    ...
    public function execute()
    {
        ...
        if ($data = $this->getRequest()->getPost('post')) {
            ...
            $this->_eventManager->dispatch(
                'borntechies_blog_post_prepare_save',
            ...
            try {
                ...
                $this->_getSession()->setData('borntechies_blog_post_data', false);

                if ($this->getRequest()->getParam('back')) {
                    $resultRedirect->setPath('borntechies_blog/*/edit', ['id' => $post->getId(), '_current' => true]);
                } else {
            ...
            $this->_getSession()->setData('borntechies_blog_post_data', $data);
