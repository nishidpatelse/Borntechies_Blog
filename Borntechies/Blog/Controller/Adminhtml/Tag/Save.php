    ...
    public function execute()
    {
        ...
        if ($data = $this->getRequest()->getPost('tag')) {
            ...
            $this->_eventManager->dispatch(
                'borntechies_blog_tag_prepare_save',
            ...
            try {
                ...
                $this->_session->setData('borntechies_blog_tag_data', false);

                if ($this->getRequest()->getParam('back')) {
                    $resultRedirect->setPath('borntechies_blog/*/edit', ['id' => $tag->getId(), '_current' => true]);
                } else {
            ...
            $this->_getSession()->setData('borntechies_blog_tag_data', $data);
