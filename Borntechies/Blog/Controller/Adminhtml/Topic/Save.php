    ...
    public function execute()
    {
        ...
        if ($data = $this->getRequest()->getPost('topic')) {
            ...
            try {
                ...
                $this->_getSession()->setData('borntechies_blog_topic_data', false);

                if ($this->getRequest()->getParam('back')) {
                    $resultRedirect->setPath('borntechies_blog/*/edit', ['id' => $topic->getId(), '_current' => true]);
                } else {
            ...
            $this->_getSession()->setData('borntechies_blog_topic_data', $data);
