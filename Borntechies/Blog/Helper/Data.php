...
namespace Borntechies\Blog\Helper;
...
use Borntechies\Blog\Model\ResourceModel\Post\Collection as PostCollection;
use Borntechies\Blog\Model\ResourceModel\Tag\Collection as TagCollection;
use Borntechies\Blog\Model\ResourceModel\Topic\Collection;
...
use Borntechies\Blog\Helper\AbstractData as CoreHelper;

/**
 * Class Data
 * @package Borntechies\Blog\Helper
 */
    ...
    public function getPostCollection($type = null, $id = null, $storeId = null)
    {
        ...
        switch ($type) {
            ...
            case self::TYPE_CATEGORY:
                $collection->join(
                    ['category' => $collection->getTable('borntechies_blog_post_category')],
            ...
            case self::TYPE_TAG:
                $collection->join(
                    ['tag' => $collection->getTable('borntechies_blog_post_tag')],
            ...
            case self::TYPE_TOPIC:
                $collection->join(
                    ['topic' => $collection->getTable('borntechies_blog_post_topic')],
