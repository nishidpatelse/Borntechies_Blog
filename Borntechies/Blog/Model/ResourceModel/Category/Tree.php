...
namespace Borntechies\Blog\Model\ResourceModel\Category;
...
use Borntechies\Blog\Model\ResourceModel\Category;
use Borntechies\Blog\Model\Category as CategoryModel;
use Zend_Db_Select;

/**
 * Class Tree
 * @package Borntechies\Blog\Model\ResourceModel\Category
 */
class Tree extends Dbp
{
    ...
    public function __construct(
        ...
        parent::__construct(
            $coreResource->getConnection('borntechies_blog_write'),
            $coreResource->getTableName('borntechies_blog_category'),
            [
    ...
    public function initInactiveCategoryIds()
    {
        ...
        $this->eventManager->dispatch('borntechies_blog_category_tree_init_inactive_category_ids', ['tree' => $this]);
