...
class Topic extends AbstractDb
{
    ...
    public function __construct(
        ...
        $this->topicPostTable = $this->getTable('borntechies_blog_post_topic');
    }
    ...
    {
        $this->_init('borntechies_blog_topic', 'topic_id');
    }
    ...
    /**
     * @param \Borntechies\Blog\Model\Topic $topic
     *
     * @return array
     */
    public function getPostsPosition(\Borntechies\Blog\Model\Topic $topic)
    {
     ...
     * @return $this
     */
    protected function savePostRelation(\Borntechies\Blog\Model\Topic $topic)
    {
        ...
        if (!empty($insert) || !empty($delete)) {
            ...
            $this->eventManager->dispatch(
                'borntechies_blog_topic_change_posts',
