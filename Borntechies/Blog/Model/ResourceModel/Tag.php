...
class Tag extends AbstractDb
{
    ...
    public function __construct(
        ...
        $this->tagPostTable = $this->getTable('borntechies_blog_post_tag');
    }
    ...
    {
        $this->_init('borntechies_blog_tag', 'tag_id');
    }
    ...
    /**
     * @param \Borntechies\Blog\Model\Tag $tag
     *
     * @return array
     */
    public function getPostsPosition(\Borntechies\Blog\Model\Tag $tag)
    {
     ...
     * @return $this
     */
    protected function savePostRelation(\Borntechies\Blog\Model\Tag $tag)
    {
        ...
        if (!empty($insert) || !empty($delete)) {
            ...
            $this->eventManager->dispatch(
                'borntechies_blog_tag_change_posts',
