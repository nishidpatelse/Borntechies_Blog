...
class Category extends AbstractDb
{
    ...
    public function __construct(
        ...
        $this->categoryPostTable = $this->getTable('borntechies_blog_post_category');
    }
    ...
    {
        $this->_init('borntechies_blog_category', 'category_id');
    }
    ...
    protected function getMaxPosition($path)
    {
        ...
        $select        = $adapter->select()->from(
            $this->getTable('borntechies_blog_category'),
            'MAX(' . $positionField . ')'
        )->where(
    ...
    public function savePostRelation(CategoryModel $category)
    {
        ...
        if (!empty($insert) || !empty($delete)) {
            ...
            $this->eventManager->dispatch(
                'borntechies_blog_category_change_posts',
