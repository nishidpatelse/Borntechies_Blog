...
namespace Borntechies\Blog\Model\ResourceModel\Comment\Grid;
...
use Borntechies\Blog\Model\ResourceModel\Comment;
use Psr\Log\LoggerInterface as Logger;
use Zend_Db_Expr;

/**
 * Class Collection
 * @package Borntechies\Blog\Model\ResourceModel\Comment\Grid
 */
class Collection extends SearchResult
{
    ...
    public function __construct(
        ...
        $mainTable = 'borntechies_blog_comment',
    ...
    public function addPostName()
    {
        $this->getSelect()->joinLeft(
            ['mp' => $this->getTable('borntechies_blog_post')],
