...
class AheadWorksM1 extends AbstractImport
{
    ...
    protected function _importPosts($data, $connection)
    {
        ...
        $this->_registry->register('borntechies_import_post_tags_collection', $tags);
    ...
    protected function _importTags($data, $connection)
    {
        ...
        if ($isReplace && isset($sourceItems)) {
            ...
            $tags = $this->_registry->registry('borntechies_import_post_tags_collection');
                ...
                foreach ($tagIds as $id) {
                    try {
                        ...
                        $this->_resourceConnection->getConnection()
                            ->insert(
                                $this->_resourceConnection->getTableName('borntechies_blog_post_tag'),
    ...
    protected function _importCategories($data, $connection)
    {
        ...
        if ($isReplace && isset($sourceItems)) {
            ...
            $this->_importCategoryPost($data, $connection, $oldCategoryIds, 'borntechies_blog_post_category');
        }
