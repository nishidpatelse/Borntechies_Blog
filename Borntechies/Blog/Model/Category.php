...
class Category extends AbstractModel
{
     ...
     * @var string
     */
    const CACHE_TAG = 'borntechies_blog_category';
     ...
     * @var string
     */
    protected $_cacheTag = 'borntechies_blog_category';
     ...
     * @var string
     */
    protected $_eventPrefix = 'borntechies_blog_category';
    ...
    public function getSelectedPostsCollection()
    {
        if (!$this->postCollection) {
            ...
            $collection->join(
                ['cat' => $this->getResource()->getTable('borntechies_blog_post_category')],
