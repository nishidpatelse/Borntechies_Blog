...
define([
    ...
    $.widget('borntechies.blogHelpfulRate', {
            options: {
                url: '',
                post_id: '',
                mode: ''
            ...
            _create: function () {
                ...
                } else if (JSON.parse(self.getCookie('blog_post_data'))) {
                    subPostId = JSON.parse(self.getCookie('blog_post_data'));
                ...
                $('#mp-blog-review div').each(function () {
                    ...
                    $(el).on('click', function () {
                        ...
                        if (JSON.parse(self.getCookie('blog_post_data'))) {
                            currentPostIds = JSON.parse(self.getCookie('blog_post_data'));
                        }
                        ...
                        if (typeof currentPostIds[post_id] !== "undefined" && self.options.mode === 0) {
                            ...
                            if (action === currentPostIds[post_id].type) {
                                ...
                                document.cookie = 'blog_post_data = ' + JSON.stringify(currentPostIds);
                            } else {
                        ...
                        $.ajax({
                            ...
                            success: function (response) {
                                ...
                                if (response['postLike']
                                    ...
                                    document.cookie = 'blog_post_data = ' + jsonStringIds;
                                }
            ...
            receiveCookiePostIds: function (postId, action, likeId, self) {
                var postData        = {
                    ...
                    receivedJsonStr = self.getCookie('blog_post_data'),
    ...
    return $.borntechies.blogHelpfulRate;
});
