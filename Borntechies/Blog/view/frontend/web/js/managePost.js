...
define([
    ...
    'uiRegistry',
    'moment',
    "Borntechies_Blog/js/get-editor"
], function ($, $t, _, modal, registry, moment, editor) {
    'use strict';

    $.widget('borntechies.blogManagePost', {
            options: {
                deleteUrl: '',
                basePubUrl: '',
                postDatas: {},
            ...
            _setPopupFormData: function(postData, pubUrl, htmlPopup){
                _.each(postData, function (value, name) {
                    ...
                    if (field.is('[type="file"]') && value) {
                        imageEL = '<a class="mp-image-link" href="' + pubUrl + 'borntechies/blog/post/' + value
                            + '" onclick="imagePreview(\'post_image_image\'); return false;" >' +
                            '<img src="' + pubUrl + 'borntechies/blog/post/' + value + '" id="post_image_image"' +
    ...
    return $.borntechies.blogManagePost;
});
